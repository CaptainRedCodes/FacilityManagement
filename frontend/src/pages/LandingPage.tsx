      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-600">
            ...
            {isAuthenticated ? (
              <Link to="/dashboard">
                <Button variant="default" className="bg-indigo-600 hover:bg-indigo-700">Dashboard</Button>
              </Link>
            ) : (
              <Link to="/login">
                <Button variant="default" className="bg-indigo-600 hover:bg-indigo-700">Sign In</Button>
              </Link>
            )}
          </nav>
        </div>
        ...
        <section className="py-20 md:py-32 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 text-sm font-medium mb-8 animate-fade-in">
              <span className="w-2 h-2 rounded-full bg-indigo-500 animate-pulse-soft"></span>
              Coming Soon
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 animate-fade-in-up">
              Intelligent Workforce &
              <span className="text-indigo-600"> Facility Management</span>
            </h1>
            ...
            {isAuthenticated && (
              <div className="mb-16 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <Card className="max-w-md mx-auto">
                  <CardContent className="pt-6">
                    <h3 className="font-semibold text-slate-900 mb-4">Welcome back, {user?.name}!</h3>
                    <Link to="/dashboard">
